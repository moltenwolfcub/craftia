...
execute as @a[tag=panda,scores={panda_item=1}] unless entity @s[nbt={Inventory:[{"id":"minecraft:cookie",Count:2b}]}] run item replace entity @s weapon.offhand with minecraft:cookie 21
